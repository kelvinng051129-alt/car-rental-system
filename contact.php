...
<script>
  // Simple front-end validation + success message (demo purpose)
  document.getElementById('contactForm').addEventListener('submit', function(e) {
    ...
    // Basic MY phone digits check (demo-level)
    const phoneOk = /^[0-9]{9,11}$/.test(phone);
    if (!phoneOk) {
      Swal.fire({
        icon: 'error',
        title: 'Invalid Phone',
    ...
    Swal.fire({
      icon: 'success',
      title: 'Message Sent!',
      text: 'Thank you. We will reply to you soon.',
      confirmButtonColor: '#d4af37',
      background: '#181818',
      color: '#fff'
    });
